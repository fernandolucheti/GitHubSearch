...
class PersistenceHelp: NSObject {
    ...
    func save(entity: String, parameters: Dictionary<String,String>)->Bool{
        var newEntity = NSEntityDescription.insertNewObjectForEntityForName("GitRepositories", inManagedObjectContext: context) as! NSManagedObjectContext
